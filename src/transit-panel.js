...
export function mountTransitPanel({root,speak,stopSpeech,isSpeaking,canSpeak,onChanged=()=>{}}){
  ...
  root.innerHTML=`<div class="transit-heading"><div><p class="eyebrow">TAKING THE BUS?</p><h2 id="transit-title">RTS rider alerts</h2><p>Published Gainesville bus-service information.</p></div><span class="badge neutral" id="transit-badge">Not checked yet</span></div>
