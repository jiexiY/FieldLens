...
$("#app").innerHTML = `
<header class="app-header"><a href="./" class="brand" aria-label="FieldLens home"><span>${icon("globe")}</span>FieldLens</a><span class="header-divider"></span><h1>Lake Alice <span>Field Study</span></h1><div class="header-meta"><i></i> Public environmental data</div><button id="sources-top" class="header-source">${icon("info")}<span>Sources</span></button></header>
