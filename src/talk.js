...
import {stopAllSpeech} from './narration.js';
...
assistant=mountVoiceAssistant({
 ...
 speak:text=>player.speak(text,prefs.rate),stopSpeech:stopAllSpeech,isSpeaking:()=>speaking,isSpeechSupported:()=>player.supported,setProvider:value=>player.setProvider(value),
